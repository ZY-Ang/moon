...
import DominosSiteLogo from "./DominosSiteLogo";
...
import {
    ...
    ACTION_SET_SELECTED_WALLET, ACTION_SET_UI_BLOCKER_STATE,
    SCREEN_ADD_WALLETS
...
import {getRequiredAmountInQuote} from "../../../../utils/exchangerates";
import {QUERY_SELECTOR_CART_AMOUNT} from "./constants/querySelectors";

// FIXME FIXME FIXME FIXME: Captchas:
//  Discussion: https://stackoverflow.com/questions/28674946/how-to-check-in-js-that-user-has-checked-the-checkbox-in-google-recaptcha
//  Solution 1: Put a listener on iframe. Seems really complex.
//  Solution 2: Continuously poll {@code window.grecaptcha.getResponse}
//  Solution 3: Poll {@code window.grecaptcha.getResponse} on slide to pay, blocking payment if fail

const DOMINOS_CURRENCY = "USD";
...
class DominosOrderPaymentScreen extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            ...INITIAL_STATE
        ...
        return (
            <div className="moon-mainflow-screen text-center">
                    ...
                    <ul className="sequence">
                        {
                            ...
                            >
                                ...
                                your order total of <b><i>{cartAmount} {cartCurrency}</i></b> is paid using your selected
                                payment method.
                            </li>
                        }
                    </ul>
                }
                {
                    ...
                    <div className="checkout-section checkout-section-wallet-select">
                        <div
                            ...
                            onClick={() => {
                                AppMixpanel.track('button_click_dominos_checkout_toggle_select_wallet');
                                ...
                                authUser.wallets
                                    ...
                                    .map(wallet =>
                                        <div
                                            ...
                                            onClick={() => {
                                                AppMixpanel.track('button_click_dominos_checkout_select_wallet',
                                                    {
                                                        'wallet': wallet.name,
                ...
                <div className="checkout-section">
                    ...
                    <div
                        onClick={() => {
                            AppMixpanel.track('button_click_dominos_checkout_cycle_wallets');
                ...
                </div>
                {
                    ...
                    <div className="checkout-payment-button mt-2">
                        <ConfirmSlider action={() => {
                            AppMixpanel.track('button_click_dominos_checkout_pay',
                                {
                ...
                }
                {
                    ...
                    <div className="checkout-payment-button">
                        <button
                            ...
                            onClick={() => {
                                AppMixpanel.track('button_click_dominos_checkout_connect_wallets');
                ...
                }
                {
                    ...
                    <div className="text-center mt-2">
                        ...
                        <p className="text-error mb-0">
                            ...
                            AppMixpanel.track('button_click_dominos_checkout_is_email_verified_support');
...
export default connect(mapStateToProps, mapDispatchToProps)(DominosOrderPaymentScreen);
