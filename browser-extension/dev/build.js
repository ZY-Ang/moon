...
const build = async () => {
    ...
    const isCredentialsOverride = (shell.env.AWS_ACCESS_KEY_ID && shell.env.AWS_SECRET_ACCESS_KEY);
    const credentials = (isCredentialsOverride)
    ...
    console.log(`credentials:\t\t\t${isCredentialsOverride ? 'AWS.Credentials' : 'AWS.SharedIniFileCredentials'}`);
